...
# ==========================================================================
"""Super Agent supply-chain workbench — runnable on free engines (DuckDB/Postgres),
drop-in for Snowflake/Databricks/Iceberg via the same adapter interface."""
from .ontology import ONTOLOGY, OntologyMapper, SYSTEMS
from .orchestrator import UNAI, USE_CASES, GEN1_AGENTS, UNAI_OF
from .adapters import DuckDBAdapter, PostgresAdapter, SnowflakeAdapter, DatabricksAdapter

__all__ = ["ONTOLOGY", "OntologyMapper", "SYSTEMS", "UNAI", "USE_CASES",
           "GEN1_AGENTS", "UNAI_OF", "DuckDBAdapter", "PostgresAdapter",
           "SnowflakeAdapter", "DatabricksAdapter"]
