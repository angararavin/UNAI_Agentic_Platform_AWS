...
const MANIFEST = {
  ...
  "capabilities": [
    ...
    {
      "id": "calculate_capacity_impact",
      "label": "calculate capacity impact",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
    ...
    {
      "id": "calculate_commercial_impact",
      "label": "calculate commercial impact",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
    ...
    {
      "id": "assess_inventory_risk",
      "label": "assess inventory risk",
      "layer": "Action",
      "systems": [
        "SAP_S4"
      ],
    ...
    {
      "id": "is_catastrophic_disaster",
      "label": " is catastrophic disaster",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
    ...
    },
    {
      ...
      "label": "detect disruptions",
      "layer": "Perception",
      "systems": [],
      "concept": null
    },
    {
      "id": "get_healthy_baseline_event",
      "label": " get healthy baseline event",
      "layer": "Action",
      "systems": [],
      "concept": null
    }
...
const PY_LIVE_INSTRUMENTED = true;
...
const REAL_COST_CAPABILITY_IDS = ["answer_question","generate_recommendations"];
