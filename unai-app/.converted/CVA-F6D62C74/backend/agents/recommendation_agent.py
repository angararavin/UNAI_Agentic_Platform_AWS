...
class RecommendationAgent:
    ...
    def generate_recommendations(
        ...
        # Smart SME AI Reasoning: Automatically leverage a live LLM (Gemini preferred,
        # Groq as fallback -- both are OpenAI-compatible chat/completions endpoints,
        # see _consult_groq_llm's provider selection) if a key is present or requested.
