...
const MANIFEST = {
  ...
  "createdAt": "2026-09-17T13:54:35.600Z",
  "layers": 7,
  "capabilities": [
    {
      "id": "demand_analyst_node",
      "label": "demand Analyst Node",
      "layer": "Action",
      "systems": [
        "ANALYTICS"
      ],
    ...
    {
      "id": "human_review_init_node",
      "label": "human Review Init Node",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
    {
      ...
      "label": "process Human Decision",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
    {
      "id": "planner_recommendation_node",
      "label": "planner Recommendation Node",
      "layer": "Action",
      "systems": [
        "SAP_IBP"
      ],
    ...
    {
      "id": "supply_impact_analyst_node",
      "label": "supply Impact Analyst Node",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
    {
      "id": "run_order_surge_analysis",
      "label": "run Order Surge Analysis",
      "layer": "Action",
      "systems": [
        "SAP_SD"
      ],
    ...
    {
      "id": "create_order_surge_graph",
      "label": "create Order Surge Graph",
      "layer": "Action",
      "systems": [
        "SAP_SD"
      ],
    ...
    {
      "id": "is_custom_api_configured",
      "label": "is Custom Api Configured",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
    {
      "id": "is_gemini_configured",
      "label": "is Gemini Configured",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
    ...
    {
      "id": "determine_initial_provider",
      "label": "determine Initial Provider",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
...
const REAL_COST_CAPABILITY_IDS = ["run_order_surge_analysis","create_order_surge_graph","call_llm","is_custom_api_configured","is_gemini_configured","get_llmclient","determine_initial_provider"];
