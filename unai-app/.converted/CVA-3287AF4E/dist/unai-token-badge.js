  ...
  window.fetch = function () {
    ...
    return origFetch.apply(this, args).then(function (res) {
      try {
        ...
        // This app's single kickoff endpoint is /api/analyze-surge (not a
        // "run" path like the single-agent apps in this series) -- the
        // unaiTokenComparison check right below is what actually gates
        // showing the badge either way.
        if (typeof url === "string" && /\/api\/(analyze-surge|.*run)/i.test(url)) {
