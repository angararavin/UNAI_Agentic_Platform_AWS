...
const MANIFEST = {
  ...
  "description": "Build a procurement and sourcing agent that analyzes spend, scorecards suppliers, awards sourcing, checks contract compliance, and automates purchase orders.",
  "source": "build",
  "createdAt": "2026-09-16T05:10:04.773Z",
  "layers": 7,
  "capabilities": [
    {
      "id": "spend_analysis",
      "label": "Spend Analysis Agent",
      "systems": [
        "ANALYTICS",
        "SAP_FI"
      ]
    },
    {
      ...
      "label": "Supplier Scorecard Agent",
      "systems": [
        "ANALYTICS"
      ]
    },
    ...
    },
    {
      ...
      "label": "Contract Compliance Agent",
      "systems": [
        "SAP_MM"
      ]
    },
