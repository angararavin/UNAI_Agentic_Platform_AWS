...
TARGETS = {"agent_1_failure/agent.py":["extract_llm_tokens","analyze_failure","repair_recommendation"],"agent_2_dwell/agent.py":["analyze_dwell","predict_sla_breach","classify_root_cause"],"agent_3_urgency/agent.py":["analyze_urgency","generate_dynamic_rdd"],"agent_4_return/agent.py":["validate_return","reconcile_serials"],"orchestrator.py":["extract_tokens","build_output"],"streamlit_app.py":["render_output","render_html"]}
