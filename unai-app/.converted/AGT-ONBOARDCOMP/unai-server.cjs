...
const MANIFEST = {
  "id": "AGT-ONBOARDCOMP",
  "name": "Employee Onboarding Compliance Agent",
  "description": "Build an employee onboarding compliance agent that checks new-hire paperwork completeness, verifies background-check status, flags missing training certifications, and schedules IT equipment provisioning.",
  "source": "build",
  "createdAt": "2026-09-15T15:14:34.126Z",
  "layers": 7,
  "capabilities": [
    {
      "id": "custom_paperwork_completeness_check",
      "label": "Paperwork Completeness Check",
      "systems": []
    },
    {
      "id": "custom_background_check_verification",
      "label": "Background Check Verification",
      "systems": []
    },
    {
      "id": "custom_training_certification_flagging",
      "label": "Training Certification Flagging",
      "systems": []
    },
    {
      "id": "custom_it_equipment_provisioning",
      "label": "IT Equipment Provisioning",
      "systems": []
    }
  ],
  "systems": [],
