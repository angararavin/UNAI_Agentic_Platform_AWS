...
const MANIFEST = {
  ...
  "description": "Build a demand planning agent that creates a statistical baseline forecast, senses demand from live orders, reconciles a consensus demand plan, layers in promotions uplift, and tracks forecast accuracy over time.",
  "source": "build",
  "createdAt": "2026-09-16T05:10:01.642Z",
  "layers": 7,
  "capabilities": [
    {
      "id": "statistical_forecast",
      "label": "Statistical Forecast Agent",
      "systems": [
        "ANALYTICS"
      ]
    },
    ...
    {
      "id": "promotions_uplift",
      "label": "Promotions Uplift Agent",
      "systems": [
        "ANALYTICS"
      ]
    },
