...
const MANIFEST = {
  ...
  "createdAt": "2026-09-17T19:11:10.608Z",
  "layers": 7,
  "capabilities": [
    {
      "id": "execute_agent1",
      "label": "execute Agent1",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
    ...
    {
      "id": "compute_token_usage",
      "label": "compute Token Usage",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
    ...
    {
      "id": "update_record_review",
      "label": "update Record Review",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
    ...
    {
      "id": "resolve_model_name",
      "label": "resolve Model Name",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
...
const REAL_COST_CAPABILITY_IDS = ["execute_agent1","execute_agent2","execute_agent3","execute_agent4","get_ai_client","compute_token_usage","resolve_model_name","start_server"];
