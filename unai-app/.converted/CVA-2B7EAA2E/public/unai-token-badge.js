  ...
  window.fetch = function () {
    ...
    return origFetch.apply(this, args).then(function (res) {
      try {
        ...
        // Generalized to any "/api/.../run" shape (this app uses /api/agent/N/run,
        // not NVIDIA's /api/agents/run) -- and the unaiTokenComparison check right
        // below is what actually gates showing the badge either way.
        if (typeof url === "string" && /\/api\/.*run/i.test(url)) {
