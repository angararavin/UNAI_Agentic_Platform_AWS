...
const MANIFEST = {
  ...
  "systems": {},
  "id": "AGT-ONBOARDAUTO",
  "createdAt": "2026-09-15T20:51:40.6582272+05:30",
  ...
  "capabilities": [
    {
      "label": "New-Hire Paperwork Completeness",
      "systems": [],
      "id": "new_hire_paperwork_completeness"
    },
    {
    ...
    {
      "label": "Missing Training Certifications",
      "systems": [],
      "id": "missing_training_certifications"
    },
    {
      "label": "IT Equipment Provisioning",
      "systems": [],
      "id": "it_equipment_provisioning"
    }
  ],
  "layers": 7,
  "governance": {
