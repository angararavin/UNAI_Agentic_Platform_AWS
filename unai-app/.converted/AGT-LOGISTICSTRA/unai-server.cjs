...
const MANIFEST = {
  ...
  "description": "Build a logistics and transportation agent that predicts ETAs, selects carriers, optimizes freight, tracks OTIF, and manages exceptions in transit.",
  "source": "build",
  "createdAt": "2026-09-16T05:10:05.760Z",
  "layers": 7,
  "capabilities": [
    {
      "id": "eta_prediction",
      "label": "ETA Prediction Agent",
      "systems": [
        "ANALYTICS"
      ]
    },
    {
      ...
      "label": "Carrier Selection Agent",
      "systems": [
        "ANALYTICS"
      ]
    },
    {
      "id": "freight_optimization",
      "label": "Freight Optimization Agent",
      "systems": [
        "ANALYTICS"
      ]
    },
    ...
    },
    {
      ...
      "label": "Exception Management Agent",
      "systems": [
        "SAP_S4"
      ]
    }
