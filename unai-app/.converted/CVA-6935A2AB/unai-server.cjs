...
const MANIFEST = {
  ...
  "capabilities": [
    ...
    {
      "id": "compute_supplier_stats",
      "label": "compute supplier stats",
      "layer": "Action",
      "systems": [
        "SAP_MM"
      ],
    ...
    {
      "id": "calculate_downstream_exposure",
      "label": "calculate downstream exposure",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
    {
      "id": "fetch_inventory_state",
      "label": "fetch inventory state",
      "layer": "Perception",
      "systems": [
        "SAP_S4"
      ],
    ...
    {
      "id": "reconcile_usable_stock",
      "label": "reconcile usable stock",
      "layer": "Action",
      "systems": [
        "SAP_S4"
      ],
    ...
    {
      "id": "evaluate_demand_coverage",
      "label": "evaluate demand coverage",
      "layer": "Action",
      "systems": [
        "ANALYTICS"
      ],
    ...
    {
      "id": "formulate_disposition",
      "label": "formulate disposition",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
    {
      "id": "calculate_usable_stock",
      "label": "calculate usable stock",
      "layer": "Action",
      "systems": [
        "SAP_S4"
      ],
    ...
    {
      "id": "map_inventory_action",
      "label": "map inventory action",
      "layer": "Action",
      "systems": [
        "SAP_S4"
      ],
    ...
    {
      "id": "compute_aging_metrics",
      "label": "compute aging metrics",
      "layer": "Action",
      "systems": [],
      "concept": null
    },
