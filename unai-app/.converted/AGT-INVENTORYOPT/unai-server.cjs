...
const MANIFEST = {
  ...
  "description": "Build an inventory optimization agent that sizes safety stock, sets reorder policy, rebalances stock across echelons, flags excess and obsolete inventory, and improves inventory turns.",
  "source": "build",
  "createdAt": "2026-09-16T05:10:02.676Z",
  "layers": 7,
  "capabilities": [
    {
      "id": "safety_stock_calc",
      "label": "Safety-Stock Agent",
      "systems": [
        "SAP_MM"
      ]
    },
    {
      "id": "reorder_policy",
      "label": "Reorder Policy Agent",
      "systems": [
        "SAP_MM"
      ]
    },
    {
      "id": "multi_echelon_balance",
      "label": "Multi-Echelon Balancing Agent",
      "systems": [
        "SAP_MM",
        "SAP_IBP"
      ]
